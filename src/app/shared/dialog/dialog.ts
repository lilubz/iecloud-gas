import {NgModule,Component,ElementRef,AfterViewInit,AfterViewChecked,OnDestroy,Input,Output,EventEmitter,Renderer2,
        ContentChildren,QueryList,ViewChild,NgZone, HostListener} from '@angular/core';
import {trigger,state,style,transition,animate} from '@angular/animations';
import {CommonModule} from '@angular/common';
// import { DomHandler } from 'primeng/components/dom/domhandler';
// import { Header, Footer, SharedModule } from 'primeng/components/common/shared';
import { DomHandler } from 'primeng/components/common/api';
import { Header, Footer, SharedModule } from 'primeng/primeng';
let idx: number = 0;
...
export class Dialog implements AfterViewInit,AfterViewChecked,OnDestroy {
    ...
    @HostListener('window:resize', ['$event']) onresize(e: Event): void {
      // this.dialog is the primeng dialog
       const {height} = this.contentViewChild.nativeElement.getBoundingClientRect();
