...
export const API = {
  ...
  // 监管事务
  'listGasStatusChange': URL + 'basicInformation/gasCylinder/listGasStatusChange.do', // 根据气瓶条码获取气瓶某段时间流转历史
  'listGasStatusChangeNew': URL + 'basicInformation/gasCylinder/listGasStatusChangeNew.do', // 获取某责任主体类型下的气瓶列表
